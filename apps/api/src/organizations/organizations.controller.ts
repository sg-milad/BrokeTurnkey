...
export class OrganizationsController {
    ...
    @ApiResponse({ status: 201, description: 'The organization has been successfully created.', type: OrganizationDto })
    ...
    @ApiResponse({ status: 200, description: 'The organization has been found.', type: OrganizationDto })
    ...
    @ApiResponse({ status: 200, description: 'The organization has been found.', type: OrganizationDto })
    async findBySlug(@Param('slug') slug: string): Promise<organization | undefined> {
    ...
    @ApiResponse({ status: 200, description: 'organization onboarded successfully.' })
